                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 text-center mb-5 mb-lg-0 align-self-center">
                            <img src="images/cloud-solutions.jpg" style="border-radius: 10px;" alt="">
                        </div>
                        <div class="col-lg-6">
                            <div class="service-process">
                                <div class="ot-heading">
                                    <span>about service</span>
                                    <h2 class="main-heading">We Provide Best <br>Cloud Solutions</h2>
                                </div>
                                <div class="row">
                                   <p class="text-justify"><em class="text-dark"><strong>We offer cloud solutions to help businesses and organizations shift their infrastructure, applications, and data to cloud-based systems. This can provide a number of benefits, including increased scalability, flexibility, cost savings, and accessibility. The company may offer various cloud services, such as Infrastructure as a Service (IaaS), Platform as a Service (PaaS), and Software as a Service (SaaS), to meet the specific needs and requirements of their clients. The cloud solutions offered by the company may be based on public, private, or hybrid cloud models, depending on the level of control, security, and privacy required.</strong></em></p>
                                </div>
                            </div>
                        </div>
                    </div>
