...
<body class="royal_preloader">
    <div id="page" class="site">
        ...
        <div id="content" class="site-content">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 align-self-center mb-30 mb-lg-0">
                            ...
                            <p>Go2ways is the partner of choice for many of the world’s leading enterprises, SMEs and technology challengers. We help businesses elevate their value through custom software development, product design, QA and consultancy services.</p>
                        ...
                        <div class="col-lg-6">
                            <div class="pabout-right">
                                ...
                                <div class="tech-wrap">
                                    ...
                                    <a class="tech-box" href="#">
                                        <div class="icon-main"><span class="icon-cloud"></span></div>
                                    </a>
                                    <a class="tech-box" href="#">
                                        <div class="icon-main"><span class="icon-file-charts"></span></div>
                                    </a>
                                </div>
                                <h5>Enterprise Development Services</h5>
                                <p>Go2ways is the partner of choice for many of the world’s leading enterprises, SMEs and technology challengers. We help businesses elevate their value through custom software development, product design, QA and consultancy services.</p>
                                <div class="ot-button">
                                    <a href="#" class="btn-details"><i class="icon-arrow-right"></i> LEARN MORE</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="about-counter pt-50">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="technology-v3-left">
                                ...
                                <div class="et-progress">
                                    <div class="ot-progress">
                                        <div class="overflow">
                                            <span class="pname f-left">Tririga</span>
                                    ...
                                    <div class="ot-progress">
                                        <div class="overflow">
                                            <span class="pname f-left">Maximo</span>
                                    ...
                                    <div class="ot-progress">
                                        <div class="overflow">
                                            <span class="pname f-left">Infrastructure</span>
