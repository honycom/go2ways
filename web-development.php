                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 text-center mb-5 mb-lg-0 align-self-center">
                            <img src="images/web-development.jpg" style="border-radius: 10px;" alt="">
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="tab-video">
                                ...
                                <div class="ot-tabs">
                                    ...
                                    <div id="tab-2518" class="tab-content">
                                        ...
                                        <p><a class="btn-details" href="web-development.php"><i class="flaticon-right-arrow-1"></i> LEARN MORE</a></p>
                                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="ot-testimonials">
                                ...
                                <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1200px, 0px, 0px); transition: all 0s ease 0s; width: 4800px;"><div class="owl-item cloned" style="width: 600px;"><div class="testi-item">
                                    ...
                                    </div></div><div class="owl-item active" style="width: 600px;"><div class="testi-item">
                                        <div class="layer1"></div>
                                        <div class="layer2">
                                            <div class="t-head flex-middle">
                                                <img src="images/testi2.png" alt="">
                                    ...
                                    </div></div><div class="owl-item" style="width: 600px;"><div class="testi-item">
                                        <div class="layer1"></div>
                                        <div class="layer2">
                                            <div class="t-head flex-middle">
                                                <img src="images/testi2.png" alt="">
                                    ...
                                    </div></div></div></div><div class="owl-nav"><button type="button" role="presentation" class="owl-prev"><i class="flaticon-back"></i></button><button type="button" role="presentation" class="owl-next"><i class="flaticon-right-arrow-1"></i></button></div><div class="owl-dots disabled"></div></div>
                            </div>
                        </div>
                    </div>
                </div>
