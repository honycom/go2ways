                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <ul class="topbar-info">
                                    <li><i class="fas fa-envelope"></i><a href="mailto:go2ways@mail.net"> go2ways@mail.net</a></li>
                                ...
                                <div class="octf-col menu-col">
                                    <nav id="site-navigation" class="main-navigation">
                                        <ul class="menu">
                                            ...
                                            <li class="menu-item-has-children current-menu-item current-menu-ancestor"><a href="#">Services</a>
                                                <ul class="sub-menu">
                                    ...
                                    <div class="octf-btn-cta">
                                        ...
                                        <div class="octf-header-module">
                                            <div class="btn-cta-group btn-cta-header">
                                                <a class="octf-btn octf-btn-third" href="contact.php">Free Quote</a>
                                            </div>
                                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <div class="space-20"></div>
                    <p class="copyright-text v2">Copyright © 2020 go2ways by ThemeModern. All Rights Reserved.</p>
