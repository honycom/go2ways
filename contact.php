    ...
    <div id="page" class="site">
        ...
        <div id="content" class="site-content">
            ...
            <section class="contact-page">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <form id="ajax-form" name="ajax-form" action="sendquery.php" method="post" class="wpcf7" onsubmit="return submitme()">
                                <div class="main-form">
                                    ...
                                    <p>
                                        <label for="phone"> 
                                            ...
                                            <span class="error" id="err-phone">Phone Number is not a valid format</span>
                                        </label>
										
                                        <input type="text" name="phone" id="phone" value="" size="40" class="" aria-required="true" aria-invalid="false" placeholder="Your Phone Number *" required="">
                                    </p>
									 <p>
                                        <label for="email"> 
                                    ...
                                    <p>
                                        ...
                                        <textarea name="message" id="message" cols="40" rows="5" class="" aria-invalid="false" placeholder="Message..." required=""></textarea>
                                    </p>
            ...
            <div class="no-padding">
                <div class="map">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d28018.25801043654!2d77.01890831125672!3d28.621301626044485!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d04d9e11a08cf%3A0xc1a5a267ef8fd396!2sUttam%20Nagar%2C%20Delhi%2C%20110059!5e0!3m2!1sen!2sin!4v1677227187021!5m2!1sen!2sin" height="500" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                </div>
            </div>
        </div>
